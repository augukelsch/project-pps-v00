...
export default function Header(props:any) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow p-5 flex items-center justify-between">
      ...
      <button className="dark:text-white text-black px-3 py-2 rounded-md dark:hover:text-gray-200 hover:text-gray-900 dark:hover:bg-gray-700 hover:bg-gray-200 flex gap-3 cursor-pointer" onClick={sendToLogin}>
         <LogOut />Sair
      </button>
    </div>
  );
