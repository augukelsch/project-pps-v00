            ...
            <tbody>
              {customers.map((customer) => (
                <tr key={customer.cnpj} className="odd:bg-white odd:dark:bg-gray-800 even:bg-gray-50 even:dark:bg-gray-900 border-b dark:border-gray-700 border-gray-200 dark:text-white">
                  ...
                  <td className="p-1">{customer.district}</td>
                  <td className="p-1">{customer.city}</td>
                  <td className="p-1">{customer.state}</td>
                  <td className="p-1">{customer.cep}</td>
                  <td className="p-1">{customer.cnpj}</td>
                  <td className="p-1">{customer.ie}</td>
                  <td className="p-1">{customer.phone}</td>
                  <td className="p-1">{customer.seller}</td>
                  <td className="flex p-1 w-18">
                    <button
                      onClick={() =>
                        handleEdit({
                          _id: customer._id,
